/*
  ...
  4. Realtime
    - Activer la synchronisation en temps réel pour mise à jour automatique
*/
...
-- Activer Realtime sur la table transactions pour synchronisation en temps réel
ALTER PUBLICATION supabase_realtime ADD TABLE transactions;

-- Commentaires pour documentation
COMMENT ON TABLE transactions IS 'Table principale pour la gestion des encaissements et décaissements avec synchronisation en temps réel';
